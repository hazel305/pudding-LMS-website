...
$html .= "<li class=\"list-group-item big d-flex justify-content-between align-items-center\" value=\"" . $rs->cateid . "\" data-cate=\"" . $rs->cateid . "\" style=\"height: 45px\"><span class=\"cate_size\">".$rs->name."</span>
